...
public class LongValidator {
     ...
     * @see jsh.util.validations.validators.LongValidator#requireNaturalNumber(long, String)
     */
     ...
     * @see jsh.util.validations.validators.LongValidator#requireNaturalNumber(long)
     */
     ...
     * @see jsh.util.validations.validators.LongValidator#requirePositiveNumber(long, String)
     */
     ...
     * @see jsh.util.validations.validators.LongValidator#requirePositiveNumber(long)
     */
